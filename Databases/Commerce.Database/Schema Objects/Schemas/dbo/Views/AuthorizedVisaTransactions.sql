...
--
create view [dbo].[AuthorizedVisaTransactions] with schemabinding as
 ...
 where Authorizations.PartnerId = 3 and TransactionLinks.PartnerId = 3 and Cards.CardBrand = 4 and Offers.OfferType in (0, 1)
   and (Authorizations.TransactionScopeId is not null or Authorizations.TransactionId is not null);

GO

create unique clustered index AuthorizedVisaTransactions_Clustered
on dbo.AuthorizedVisaTransactions
