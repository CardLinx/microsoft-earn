...
--
create view [dbo].[RedeemedVisaTransactions] with schemabinding as
 ...
 where TransactionLinks.PartnerId = 3 and Cards.CardBrand = 4 and Offers.OfferType in (0, 1)
...
create unique clustered index RedeemedVisaTransactions_Clustered
on dbo.RedeemedVisaTransactions
