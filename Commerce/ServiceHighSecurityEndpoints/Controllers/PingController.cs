...
namespace Lomo.Commerce.Service.HighSecurity
{
    ...
    public class PingController : ApiController
    {
        ...
        /// <summary>
        /// Pings the Merchants, Commerce, and Users databases.
        /// </summary>
        /// <returns>
                                                   ...
                                                   bool usersSuccess)
        {
            ...
            string responseText = String.Format("Operations success report: Commerce {0}; Users {1}",
                                                commerceSuccess, usersSuccess);
