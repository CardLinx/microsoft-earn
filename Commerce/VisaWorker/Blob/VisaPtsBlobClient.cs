...
namespace Lomo.Commerce.VisaWorker
{
    ...
    /// </summary>
    public class VisaPtsBlobClient : AzureBlobClient
    {
         /// <summary>
        ...
        /// </remarks>
        public VisaPtsBlobClient()
        {
        }

        /// <summary>
        /// Constructor to create Pts Client Instance
        /// </summary>
        /// <param name="connectionString">
        /// Azure Storage Connection String
        /// </param>
        public VisaPtsBlobClient(string connectionString, CommerceLog log) 
            : base(connectionString, "visa-ptsfiles")
        {
            Log = log;
        }
